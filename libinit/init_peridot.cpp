...
void vendor_load_properties() {
    ...
    if (region == "IN") {
        device = "peridot";
        brand = "POCO";
        description = "peridot_global-user 15 AP3A.240905.015.A2 OS2.0.204.0.VNPMIXM release-keys";
        fingerprint = "POCO/peridot_global/peridot:15/AP3A.240905.015.A2/OS2.0.204.0.VNPMIXM:user/release-keys";
        marketname = "POCO F6";
        model = "24069PC21I";
    } else if (region == "GL") {
        device = "peridot";
